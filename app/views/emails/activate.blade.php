...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body  offset="0" class="body" style="padding:0 !important; margin:0 !important; display:block !important; background:#eeebeb; -webkit-text-size-adjust:none" bgcolor="#eeebeb">
              ...
              <tr>
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    ...
                    Glad to see you here! To activate your account, just click the button below.<br><br>
                    ...
                    <br>
                      <div><!--[if mso]>
                        <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://" style="height:45px;v-text-anchor:middle;width:220px;" stroke="f" fillcolor="#f5774e">
                          ...
                          <center>
                        <![endif]-->
                            <a href="{{ route('activating', ['code' => $user->activation_code, 'email' => e($user->email)]) }}"
                          style="background-color:#f5774e;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:220px;-webkit-text-size-adjust:none;">Activate my account</a>
                            <!--[if mso]>
                          </center>
                        </v:rect>
                      <![endif]--></div>
