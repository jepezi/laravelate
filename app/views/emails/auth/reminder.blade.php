              ...
              <tr>
                ...
                <table style="margin: 0 auto;" cellspacing="0" cellpadding="0" class="force-width-80">
                  <tr>
                    ...
                    <br>
                    Hi Bob,<br><br>
                    To reset your password, please click the link below. It will send you to the page to enter your email address and set a new password.<br><br>
                    <a href="{{ URL::to('password/reset', array($token)) }}">Click here to reset password</a>.<br><br>
                    
                    That's it!<br>
                    Awesome Inc <br><br>
                    Please note that this link will expire in {{ Config::get('auth.reminder.expire', 60) }} minutes. You will have to start over again.<br><br><br>
                    <div class="mobile-br">&nbsp;</div>
                    </td>
                  </tr>
                </table>
